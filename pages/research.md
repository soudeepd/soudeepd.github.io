...
- **Deb, S**. Forecasting count data using time series model with exponentially decaying covariance structure. Submitted. [[pre-print]](https://arxiv.org/abs/2004.03130)
